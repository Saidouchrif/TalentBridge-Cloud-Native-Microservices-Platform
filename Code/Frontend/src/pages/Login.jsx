    ...
    <div style={{ minHeight: "80vh", display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: "#f8fafc", padding: "2rem" }}>
      <div style={{ width: "100%", maxWidth: "450px", backgroundColor: "white", padding: "2.5rem", borderRadius: "24px", boxShadow: "0 20px 40px rgba(0,0,0,0.04)", border: "1px solid #e2e8f0" }}>
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          ...
          <p style={{ color: "#64748b", margin: 0 }}>Connectez-vous pour suivre vos candidatures.</p>
        </div>
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" style={{ width: "100%", padding: "14px", backgroundColor: "#0f172a", color: "white", fontSize: "1rem", fontWeight: "600", borderRadius: "10px", border: "none", cursor: "pointer", transition: "transform 0.1s", marginTop: "0.5rem" }}>
            Se connecter
          </button>
        </form>
        <p style={{ textAlign: "center", marginTop: "2rem", color: "#64748b", fontSize: "0.9rem" }}>
          Pas encore de compte ? <a href="/register" style={{ color: "#3b82f6", fontWeight: "600", textDecoration: "none" }}>S'inscrire</a>
        </p>
      </div>
    </div>
  );
