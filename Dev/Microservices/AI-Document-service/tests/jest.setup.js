...
jest.mock("../src/services/ai.service", () => {
  ...
  return {
    ...
    generateContent: jest
      .fn()
      .mockResolvedValue("Contenu genere par IA (mock test)."),
  };
});
...
function resoudreUrlBaseTests() {
  ...
  const repli = "postgresql://test:test@127.0.0.1:5432/document_test";
